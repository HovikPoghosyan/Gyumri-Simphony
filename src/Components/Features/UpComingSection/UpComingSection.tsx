...
function UpComingSection() {
   const itemsList = [ 
      <ConcertCard title = "Violin Concert" time='18 : 00' location='Gyumri, Ozanyan 1(Hayordyats tun)' imageUrl='\Images\image2.jpg' data='December 16' members={[{ position: 'Conductor', name: 'Armen Kartchyan'}, { position: 'Soloist', name: 'Artyom Richagov (violin)'}, { position: 'Soloist', name: 'Armen Badalyan (violin)'}]} />, 
      <ConcertCard title = "Violin Concert" time='18 : 00' location='Vanadzor Tigran Metsi Ave. 2 ' imageUrl='\Images\image2.jpg' data='December 17' members={[{ position: 'Conductor', name: 'Armen Kartchyan'}, { position: 'Soloist', name: 'Artyom Richagov (violin)'}, { position: 'Soloist', name: 'Armen Badalyan (violin)'}]} />, 
