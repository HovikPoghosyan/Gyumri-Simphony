         ...
         <div className = { classNames( 'container', styles.container ) } >
            ...
            <div className={ styles.column }>
                  <div className={ styles.columnContent}>
                     ...
                     <a  target="_blank" className={ styles.infoRow }><FontAwesomeIcon className={ styles.infoFaIcon } icon = { faLocationDot }/><span className={ styles.text }>Armenia, Gyumri Ozanyan 1 </span></a>
                     <a  className={ styles.infoRow }><FontAwesomeIcon className={ styles.infoFaIcon } icon = { faPhone }/><span className={ styles.text }>+374 (93) 90-98-98</span></a>
                     <a  className={ styles.infoRow }><FontAwesomeIcon className={ styles.infoFaIcon } icon = { faEnvelope }/><span className={ styles.text }>gyumrisymphony@gmail.com</span></a>             
            ...
            <div className={ styles.column }>
                  <div className={ styles.columnContent}>
                     ...
                     <a  target="_blank" className={ styles.infoRow }><FontAwesomeIcon className={ styles.infoFaIcon } icon = { ['fab', 'instagram' ] }/><span className={ styles.text }>@gyumri.symphony</span></a>
                     <a  target="_blank" className={ styles.infoRow }><FontAwesomeIcon className={ styles.infoFaIcon } icon = { ['fab', 'youtube' ] }/><span className={ styles.text }>@gsso</span></a>   
                     <a  target="_blank" className={ styles.infoRow }><FontAwesomeIcon className={ styles.infoFaIcon } icon = { ['fab', 'facebook' ] }/><span className={ styles.text }>@gyumrisso</span></a>                       
